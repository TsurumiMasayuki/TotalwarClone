...
public:
	...
	* \param pIndex	Position of the Connect to setDestination.
	* \param pAtIndex	Position where to setDestination the Connect.
	* \return			\c True if the Connect was moved.
	* \remarks After the setDestination, the Connect will be precisely at position pAtIndex.
	*/
	bool MoveSrcAt(int pIndex, int pAtIndex);

	/** Change the position of a source Connect.
	* \param pSrc		Connect to setDestination.
	* \param pAtSrc	Connect at which position to setDestination.
	* \return			\c True if the Connect was moved.
	* \remarks After the setDestination, the Connect will be precisely at the position where pAtSrc was before the setDestination.
	*/
